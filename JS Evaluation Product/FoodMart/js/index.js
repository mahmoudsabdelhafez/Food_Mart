    ...
    products.forEach((product, index) => {
      if (categoryName != product.category) {
        ...
        document.getElementById("card_trending").innerHTML += `
          <div class="col product-item" data-product-id="${product.id}">
            ...
            <figure>
              <a href="" title="Product Title">
                <img id="product-img-${product.id}" src="${product.image_url
          }" class="tab-image">
              </a>
            </figure>
          ...
          }" onclick="initProductQty()" type="button" class="quantity-left-minus btn btn-danger btn-number btn_cart_count" data-type="minus">
                    <svg width="16" height="16"><use xlink:href="#minus"></use></svg>
                  </button>
                </span>
                <input type="text" id="quantity" name="quantity" class="form-control input-number" value="1">
                <span class="input-group-btn">
                  <button onclick="initProductQty()" type="button" class="quantity-right-plus btn btn-success btn-number" data-type="plus">
